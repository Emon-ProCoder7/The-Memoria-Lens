...
// --- API Helpers ---
const apiKey = import.meta.env.VITE_GEMINI_API_KEY || ""; // Read from Vercel/Local env
...
const generateFaceSwap = async (brideImageBase64, groomImageBase64, referenceUrl, referenceDesc) => {
  ...
  if (referenceBase64) {
    promptText = `The final result should be an artistic synthesis. Focus on blending the lighting, atmosphere, and general facial structure of the targets into the scene. Create a seamless, high-end editorial look. Both subjects should be looking towards the camera.`;
    ...
    promptText = `Generate an artistic photorealistic masterpiece based on the description.
        Reference Description: ${referenceDesc}
    - Maintain the exact cinematic lighting and composition described.
        - The goal is an artistic photographic representation using the provided facial references.`;
